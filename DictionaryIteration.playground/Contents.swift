 ...
 */
var highestSellingAlbums = ["Nirvana": "Nevermind", "Blondie": "Parallel Lines", "The Kinks": "Low Budget", "The Beatles": "Sgt. Pepper's Lonely Hearts Club Band"]
 ...
 */
highestSellingAlbums["Pixie's"] = "Doolittle"
 ...
 */
highestSellingAlbums["The Kinks"] = nil
...
if let highestSellingAlbum = highestSellingAlbums[bandName] {
    print("\(bandName)'s top-selling album was \(highestSellingAlbum).")
}
 ...
 */
for (band, album) in highestSellingAlbums {
 ...
 */
var examResultsbyGradeVar = [9:"A", 10:"B", 11:"C", 12:"D"]
 ...
 * Grade 12: B
 */
let examResultsbyGrade = [9:"B", 10:"A", 11:"C", 12:"B"]
 ...
 */
for (key, value) in examResultsbyGrade {
...
let scores = Array(examResultsbyGrade.values)
let topScore = scores.sort()[0]
var gradeWithTopScore:Int?

for (grade, score) in examResultsbyGrade {
    if score == topScore {
        gradeWithTopScore = grade
    }
}
if let gradeWithTopScore = gradeWithTopScore {
    print("Grade \(gradeWithTopScore) got the highest score with \(topScore).")
}
